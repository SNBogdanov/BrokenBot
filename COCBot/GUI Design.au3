...
$ConfigLoadSave = GUICtrlCreateGroup(GetLangText("ConfigLoadSave"), 20, 40, 375, 55)
$btnLoad = GUICtrlCreateButton(GetLangText("btnLoad"), 180, 59, 97, 25)
GUICtrlSetOnEvent(-1, "btnLoad")
$btnSave = GUICtrlCreateButton(GetLangText("btnSave"), 280, 59, 97, 25)
GUICtrlSetOnEvent(-1, "btnSave")
$lblConfig = GUICtrlCreateLabel(getfilename($config), 40, 65, 112, 17)
GUICtrlCreateGroup("", -99, -99, 1, 1)

$grpLanguage = GUICtrlCreateGroup(GetLangText("grpLanguage"), 20, 100, 375, 50)
$cmbLanguage = GUICtrlCreateCombo("", 30, 120, 347, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
PopulateLanguages()
_GUICtrlComboBox_SetCurSel($cmbLanguage, _GUICtrlComboBox_FindStringExact($cmbLanguage, $StartupLanguage))

$chkMinimizeTray = GUICtrlCreateCheckbox(GetLangText("chkMinimizeTray"), 40, 160, 150, 15)
GUICtrlSetTip(-1, GetLangText("chkMinimizeTrayTip"))

$chkSpeedBoost = GUICtrlCreateCheckbox(GetLangText("chkSpeedBoost"), 40, 180, 100, 15)
GUICtrlSetTip(-1, GetLangText("chkSpeedBoostTip"))
$chkHelper = GUICtrlCreateCheckbox(GetLangText("chkHelper"), 202, 180, 150, 15)
GUICtrlSetTip(-1, GetLangText("chkHelperTip"))

Local $lblFontt=GUICtrlCreateLabel("Log Font :",40,205,-1,-1)
Global $lblFontName=GUICtrlCreateLabel("Arial",100,205,100,20)
Global $lblFontSize=GUICtrlCreateLabel("8",200,205,25,20)
Local $btnFont=GUICTrlCreateButton("Set Font",220,202,-1,20)
...
$tiMinimizeTray = TrayCreateItem(GetLangText("tiMinimizeTray"))
TrayCreateItem("")
