...
;Func _CaptureRegion($iLeft = 0, $iTop = 0, $iRight = 860, $iBottom = 780, $ReturnBMP = False, $NeedMove = False)
Func _CaptureRegion($iLeft = 0, $iTop = 0, $iRight = 860, $iBottom = 732, $ReturnBMP = False, $NeedMove = False)
